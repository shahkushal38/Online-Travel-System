  ...
  <body>
    ...
    <header>
      ...
      <nav class="navbar">
        ...
        <a href="get_requests.php">Your Requests</a>
      </nav>
    ...
    <section class="book" id="book">
      ...
      <div class="row">
        ...
        <form action="set_requests.php" method="get">
          <div class="inputBox">
            <h3>where to</h3>
            <input type="text" name="dest" placeholder="place name" />
          </div>
          <div class="inputBox">
            <h3>how many</h3>
            <input type="number" name="people" placeholder="number of guests" />
          </div>
          <div class="inputBox">
            <h3>arrivals</h3>
